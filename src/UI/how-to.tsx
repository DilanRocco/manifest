        ...
        <VStack gap={6} align="stretch">
          ...
          >
            <Text color="whiteAlpha.700" fontStyle="italic" mb={2}>
              - I'm someone who makes a difference in the lives of others
            </Text>
            <Text color="whiteAlpha.700" fontStyle="italic" mb={2}>
               - I can get whatever I put my mind towards
            </Text>
            <Text color="whiteAlpha.700" fontStyle="italic">
              - At work, I am appreciated for the effort I put in
            </Text>
          </Box>
          <Box 
          color="white" 
          ...
          <Box>
            ...
            <Text color="whiteAlpha.800" mb={4}>In the bible it says:</Text>
